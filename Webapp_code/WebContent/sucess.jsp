            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
						...
						<li><a class="nav-link" href="main.jsp">Logout</a></li>
	...
	<!-- Start Banner -->
		...
		<div class="container">
			<div class="row">
				...
				&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<img src="images/sucess4.png">
				
			<h1>                 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp           Your order has been places succesfully</h1>
			<div class="row">
				<div class="col-lg-12">
