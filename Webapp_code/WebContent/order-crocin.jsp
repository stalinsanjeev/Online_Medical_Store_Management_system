					...
					<div class="owl-carousel owl-theme">
						<div class="item">
							<div class="serviceBox">
								...
								<h3 class="title">Crocin tablets</h3>
								<p>quantity of 30 tablets</p><br><br>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="uname" type="text" placeholder="user name" class="form-control input-md">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="quantity" type="text" placeholder="no.pieces" class="form-control input-md">
                                        <INPUT TYPE="text" NAME="pid" style="display: none" value="101">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label" for="name">Shipping address</label>
